...
export function AuthPage({
  ...
  return (
    <div className="flex min-h-screen flex-col bg-linear-to-br from-[#02050b] via-[#050c1d] to-[#071426] text-slate-100">
      ...
      <main className="mx-auto w-full max-w-5xl px-6 py-12">
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <section className="rounded-4xl border border-white/10 bg-white/5 p-8 shadow-[0_25px_70px_rgba(2,6,23,0.65)] backdrop-blur">
